...
function library:Window(text,logo,keybind)
	...
	Hub.Text = "KAITAN"
	Hub.TextColor3 = Color3.fromRGB(0, 204, 0)
	Hub.TextSize = 17.000
	...
	do  local ui =  game:GetService("CoreGui"):FindFirstChild("Frog")  if ui then ui:Destroy() end end
	...
	SearchStroke.Color = Color3.fromRGB(0, 204, 0)
...
--[[
		...
		function main:Slider(text,min,max,set,callback)
			...
			Slider.BackgroundColor3 = Color3.fromRGB(0, 204, 0)
			...
			bar1.Name = "bar1"
			bar1.Parent = bar
			bar1.BackgroundColor3 = Color3.fromRGB(0, 204, 0)
			...
			slidervalue.BackgroundColor3 = Color3.fromRGB(0, 204, 0)
		...
		function main:Line()
			...
			Line.Name = "Line"
			Line.Parent = Linee
			Line.BackgroundColor3 = Color3.fromRGB(0,204,0)
